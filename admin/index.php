  ...
  <div class="main">
    ...
    <div class="main-info">
      ...
      <div class="main-info1">
        ...
        <form method="post">
          <input type="text" name="username" id="u" placeholder="Username" required=" " autocomplete="off">
          <input type="password" name="password" id="p" placeholder="Password" required=" " autocomplete="off">
