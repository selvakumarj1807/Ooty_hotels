...
var e = {
    ...
    flatPicker: function () {
      ...
      if (e.isVariableDefined(picker)) {
        ...
        element.forEach(function (item) {
          ...
          var dateFormat = item.getAttribute('data-date-format') ? item.getAttribute('data-date-format') : item.getAttribute('data-enableTime') == 'true' ? "h:i K" : "d M Y";
    ...
    guestSelector: function () {
      ...
      function showElements(){
        ...
        let roomText = rooms > 1 ? 'Room' : 'Room';
        let guestText = totalAdults > 1 ? 'Adult': 'Adult';
    
        let resultText = adults+' '+guestText+' '+rooms+' '+roomText+' '+child+' Child';
