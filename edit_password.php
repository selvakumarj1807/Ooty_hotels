...
<!-- Mirrored from booking.webestica.com/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Feb 2024 04:59:24 GMT -->
<head>
...
if (isset($_POST['submit'])) {
    ...
    $sql="UPDATE `user` SET `password`='$confirm_password', `cpass`='$confirm_password' WHERE `email`= '$email'";
					...
					<div class="row g-0">
						...
						<div class="col-lg-6 order-1">
							<div class="p-4 p-sm-6">
								...
								<!-- Form START -->
								<form class="mt-4 text-start" role="form" method="POST" enctype="multipart/form-data">
									<!-- Email -->
									...
									<!-- Button -->
									<div><button type="submit" name="submit" class="btn btn-primary w-100 mb-0">Reset</button></div>
