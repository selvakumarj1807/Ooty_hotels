...
<!-- Mirrored from booking.webestica.com/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Feb 2024 04:59:24 GMT -->
...
if (isset($_POST['reset'])) {
	...
	if ($result && $result->num_rows > 0) {
		...
		echo "<script type='text/javascript'>window.location.href = 'edit_password.php?email=$email';</script>";
		exit;
	} else {
		// Email does not exist, show an alert and redirect to forgot-password page
		echo "<script>alert('Email is invalid');</script>";
		echo "<script type='text/javascript'>window.location.href = 'forgot-password.php';</script>";
		exit;
	}
}
?>
							...
							<div class="row g-0">
								...
								<div class="col-lg-6 order-1">
									<div class="p-4 p-sm-7">
										...
										<!-- Form START -->
										<form class="mt-sm-4 text-start" method="post">
											<!-- Email -->
											<div class="mb-3">
											...
											<!-- Button -->
											<div class="d-grid"><button type="submit" name="reset" class="btn btn-primary">Reset Password</button></div>
...
<!-- Mirrored from booking.webestica.com/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Feb 2024 04:59:25 GMT -->
