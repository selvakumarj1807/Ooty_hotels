...
if (isset($_POST['login'])) {
	...
	$enter_pass = $_POST['password'];

	$res = mysqli_query($conn, "SELECT * FROM user");
	while ($row_r = mysqli_fetch_array($res)) {
		$email = $row_r['email'];
		$password = $row_r['password'];
		//$user_name = $row_r['fname'];

		if ($enter_email == $email && $enter_pass == $password) {
...
<!-- Mirrored from booking.webestica.com/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jan 2024 05:10:03 GMT -->
									...
									<div class="p-4 p-sm-7">
										...
										<div>
											<form class="mt-4 text-start" method="post">
												...
												<!-- Button -->
												<div><button type="submit" name="login" class="btn btn-primary w-100 mb-0">Login</button></div>
												...
												<!-- Copyright -->
												<div class="text-primary-hover text-body mt-3 text-center"> Copyrights ©2024 Booking. Build by <a href="https://www.tamilinfotechnology.com/" class="text-body">Tamil Info technology</a>. </div>
											</form>
											<!-- Form END -->
										</div>
									</div>
...
<!-- Mirrored from booking.webestica.com/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jan 2024 05:10:04 GMT -->
